...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`persona` (
  ...
  `imagen` VARCHAR(200) NULL DEFAULT 'default',
...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`estudiante` (
  ...
  `anioIngreso` TINYINT(4) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`aula` (
  ...
  `piso` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
  `capacidad` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
  `estado` TINYINT(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`codAula`))
ENGINE = InnoDB
AUTO_INCREMENT = 1
...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`ciclo_academico` (
  ...
  `semestre` VARCHAR(2) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
  `estado` TINYINT(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`plan_estudio` (
  ...
  `anioPlanEstudio` VARCHAR(4) NULL DEFAULT NULL,
  `numeroCiclos` VARCHAR(2) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
  `numeroCursosObligatorios` VARCHAR(2) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
  `numeroCursosLectivos` VARCHAR(2) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`curso` (
  ...
  `creditos` TINYINT(3) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `plataforma_uisrael`.`sesion_clase` (
  ...
  `diaSemana` TINYINT(1) NULL DEFAULT NULL,
